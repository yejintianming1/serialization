...
public class AvroSerializer implements ISerializer {
    ...
    public static void main(String[] args) throws IOException {
        ...
        userAvro.setAge(28);
        userAvro.setEmail("wuyangsheng@deppon.com");
        userAvro.setName("wuyangsheng");
        ...
        userAvro2.put("email","wuyangsheng@deppon.com");
        userAvro2.put("name", "wuyangsheng");
        ...
        //2.2 反序列化
        DatumReader<User> userDatumReader2 = new SpecificDatumReader<>(User.class);
